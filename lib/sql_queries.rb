...
"SELECT projects.title, projects.funding_goal, SUM(pledges.amount) AS pledges.total_pledge FROM projects JOIN pledges ON projects.id=pledges.project_id WHERE projects.funding.goal<pledges.total_pledge"
end
